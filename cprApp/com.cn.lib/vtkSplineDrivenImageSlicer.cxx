...
vtkSplineDrivenImageSlicer::vtkSplineDrivenImageSlicer( )
{
   ...
   this->SliceExtent[0] = 135;
   this->SliceExtent[1] = 55;
  ...
  vtkInformationVector *outputVector)
{
  ...
  pathCopy->ShallowCopy( inputPath );
   ...
   this->dy_outputImage = outputImage;
...
//-----------------------------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------
vtkFrenetSerretFrame *vtkSplineDrivenImageSlicer::get_localFrenet(){
    return this->localFrenetFrames;
}

vtkImageData *vtkSplineDrivenImageSlicer::get_OutputImage(){
    return this->dy_outputImage;
}
